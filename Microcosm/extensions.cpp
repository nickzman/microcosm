...
// These must match the externs in extensions.h, or you will have linker errors.
...
int initExtensions(){
	if(queryExtension("GL_ARB_multitexture") && queryExtension("GL_ARB_shader_objects")){
		...
		glUniform3fARB = (PFNGLUNIFORM3FARBPROC)getProcAddr("glUniform3fARB");
